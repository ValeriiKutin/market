...
const SportProductCard = ({ product }: any) => {
    ...
    return (
        ...
        >
            <Link href={`product/${product.id}-${String(product?.title).toLowerCase()}`} key={product.id}> <img src={product?.image} alt="" className="w-[200px] h-[200px] object-cover rounded-lg max-w-full" />
